...
syms k1 k2 k3 k4 gam1 gam2 gam3 gam4
...
title = {'Vertical Equilibrium, State Trajectories with initial state [ 0 0 0.1\pi 0]';
         'Vertical Equilibrium, State variables with time domain characteristics'};
controlled_pendulum_plotter(t,x, init, P_up_far,[1,2], title);
...
title = {'Vertical Equilibrium, State Trajectories with initial state [ 0 0 0.1\pi 0]';
         'Vertical Equilibrium, State variables with time domain characteristics'};
controlled_pendulum_plotter(t,x, init, P_up_complex,[1,2], title);
